...
save('../Data_metrics_8415_datasets_X_train.npy',X_train_datasets_5d_resampled)
save('../Data_metrics_8415_datasets_X_test.npy',X_test_datasets_5d_resampled)
save('../Data_metrics_8415_datasets_y_train.npy',y_train_datasets_5d_resampled)
save('../Data_metrics_8415_datasets_y_test.npy',y_test_datasets_5d_resampled)



#prediction_y = load('E:\Internships_19\Internship(Summer_19)\Imbalanced_class_classification\Class_Imabalanced_Learning_Code\CIL Code\RESULTS\Data_metrics_8415_datasets_prediction.npy')
#y_test_datasets_5d_resampled = load('E:\Internships_19\Internship(Summer_19)\Imbalanced_class_classification\Class_Imabalanced_Learning_Code\CIL Code\RESULTS\Data_metrics_8415_datasets_test.npy')
